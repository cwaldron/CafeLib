...
@echo on
nuget push %cafelibpath%\Core\CafeLib.Core\%libPath%\CafeLib.Core.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Binding\%libPath%\CafeLib.Core.Binding.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Client.Request\%libPath%\CafeLib.Core.Client.Request.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Client.SignalR\%libPath%\CafeLib.Core.Client.SignalR.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.IoC\%libPath%\CafeLib.Core.IoC.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Messaging\%libPath%\CafeLib.Core.Messaging.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Queueing\%libPath%\CafeLib.Core.Queueing.0.6.3.nupkg %apikey% -source %nugetRepo%
nuget push %cafelibpath%\Core\CafeLib.Core.Runnable\%libPath%\CafeLib.Core.Runnable.0.6.3.nupkg %apikey% -source %nugetRepo%
